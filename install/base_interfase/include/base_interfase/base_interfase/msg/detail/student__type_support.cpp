...
{
  new (message_memory) base_interfase::msg::Student(_init);
}

void Student_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_interfase::msg::Student *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Student_message_member_array[3] = {
  {
    ...
    offsetof(base_interfase::msg::Student, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfase::msg::Student, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfase::msg::Student, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Student_message_members = {
  "base_interfase::msg",  // message namespace
  "Student",  // message name
  3,  // number of fields
  sizeof(base_interfase::msg::Student),
...
get_message_type_support_handle<base_interfase::msg::Student>()
{
  return &::base_interfase::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interfase, msg, Student)() {
  return &::base_interfase::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
